define("common/wx/report_util.js", ["common/wx/Tips.js", "biz_common/moment.js", "biz_web/lib/highcharts.js", "biz_web/ui/dropdown.js", "biz_web/ui/dateRange.js", "common/wx/pagebar.js"], function (e) {
    ...
    function t(e) {
        var e = $.extend(!0, {
            ...
            theme: "ta",
            success: function (o) {
                var i = o.startDate, r = o.endDate;
                $("#" + t.inputId).html(i + " 至 " + r), e.callback(i, r), a && (a.value = null);
            },
        ...
        var a;
        if (e.dropDom) {
            var o = "最近7天", i = "最近15天", r = "最近30天", n = {};
            n[(e.isTodayValid ? b : u) + "_" + l().add("d", e.isTodayValid ? -29 : -30).format("YYYY-MM-DD")] = r,
                n[(e.isTodayValid ? b : u) + "_" + l().add("d", e.isTodayValid ? -14 : -15).format("YYYY-MM-DD")] = i,
                n[(e.isTodayValid ? b : u) + "_" + l().add("d", e.isTodayValid ? -6 : -7).format("YYYY-MM-DD")] = o;
            var s = n[e.endtime + "_" + e.begintime] || "最近7天", a = new d({
                container: e.dropDom,
                label: s,
                data: [{
                    name: o,
                ...
                callback: function (a) {
                    if (a) {
                        var o = a, i = l().add("d", -o);
                        e.isTodayValid && (i = i.add("d", 1)), i = i.format("YYYY-MM-DD");
                        var r = l();
                        e.isTodayValid || r.add("d", -1), r = r.format("YYYY-MM-DD"), $("#" + t.inputId).html(i + " 至 " + r),
                            e.callback(i, r);
                    }
                }
            });
    ...
    function o(e) {
        ...
        $(e.container).on("click", function () {
            ...
            var i = $(e.container).removeClass("single_up").removeClass("single_down"), r = i.filter("[sortkey=" + e.sortkey + "]");
            r.addClass(e.sorttype == t ? "single_up" : "single_down"), e.callback && e.callback(e, e);
        });
    }
