define("statistics/components/date-range2.js", ["statistics/components/event-emitter.js", "biz_web/ui/dateRange.js", "biz_common/moment.js", "common/wx/report_util.js"], function (t) {
    ...
    function e(t) {
        ...
        }, this.cid = o++, this.isEmit = !0, this.$single = m(this.settings.singleContainer), this.$compare = m(this.settings.compareContainer),
            this.$compareBtn = m(this.settings.compareBtn), this._init();
    }
    ...
    var s = t("statistics/components/event-emitter.js"), i = t("biz_web/ui/dateRange.js"), n = t("biz_common/moment.js"), r = "YYYY-MM-DD", o = 0, d = "js_date_container", h = t("common/wx/report_util.js"), m = jQuery, D = {
        needCompare: !0
    ...
    return c._init = function () {
        ...
        }) : (this.singleRange = h.initDateRange({
        ...
        var e = n(t.startDate), a = n(t.endDate), s = (parseInt(a.format("X")) - parseInt(e.format("X"))) / 86400, i = n(t.startDate).subtract(1, "days"), o = n(t.startDate).subtract(s + 1, "days"), d = e.format(r), h = a.format(r), m = o.format(r), D = i.format(r);
        this.range1.setDate({
            startDate: d,
            endDate: h
        }), this.range2.setDate({
            startDate: m,
            endDate: D
        }), this.dateObj.startDate = d, this.dateObj.endDate = h, this.dateObj.startCompareDate = m,
